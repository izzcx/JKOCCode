...
//        _fullImageView =(UIImageView *)gifView;
//        
//        UIImage *image = [UIImage imageWithData:_data];
//        
...
//            
//            
//            gifView.height = kScreenHeight;
//            gifView.width =width/height*kScreenWidth;
//            gifView.left = (kScreenWidth - gifView.width)/2;
//            
//        }else{
//            
//            gifView.width = kScreenWidth;
//            gifView.height= height/width*kScreenHeight;
//            
//             gifView.top = (kScreenHeight-gifView.height)/2;
//        }
